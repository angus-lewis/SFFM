...
let
    ...
    vecΔ = [2.5 1.25/2 1.25/4]#[5 2.5 1.25 1.25/2 1.25/4]
    errPH = vecNBases
    errME = vecNBases
    errbkwdME = vecNBases
    errDG = vecNBases
    ...
    for Δ in vecΔ
        ...
        for NBases in vecNBases
            ...
            Erlang = MakeME(CMEParams[NBases],mean=Δ)#MakeSomeCoxian(NBases, mean = Δ)#MakeErlang(NBases, mean = Δ)
            ...
            ME = reversal(Erlang)#MakeME(CMEParams[NBases],mean=Δ)
        ...
        plot!(p,vecNBases,log.(globalerrbkwdME),label=false,linestyle=:dashdot,colour=:green)
...
#             )
#
#             SomePH = MakeSomePH(NBases, mean = Δ)
#
